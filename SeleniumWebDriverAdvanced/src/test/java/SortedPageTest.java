...
public class SortedPageTest extends SortedPageBeforeAndAfter {
    ...
    @Test(priority = 1, description = "Тест сортировки по цене")
    ...
    public void sortingByDate() {
        ...
        List<String> expected = sortedMethods.checkSortingDate();
        List<String> actual = sortedMethods.checkSortingDateActual();
        Assert.assertEquals(actual, expected);
    }
